"""
Django settings for HASSpathways project.
...
SECRET_KEY = '5#6!zk6zuf-s=q(@xcv4mnry4ma6w@5rep&5ls-csmt#8aw#-n'
...
ROOT_URLCONF = 'HASSpathways.urls'
...
WSGI_APPLICATION = 'HASSpathways.wsgi.application'
